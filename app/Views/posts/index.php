            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/posts" class="bg-indigo-100 text-indigo-700 px-3 py-2 rounded-md text-sm font-medium">Posts</a>
                        ...
                        <?php if (empty($posts)): ?>
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                    No posts found. <a href="/posts/create" class="text-blue-600 hover:text-blue-900">Create your first post</a>
                                </td>
                            </tr>
                        <?php else: ?>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500">
                                            <?php echo htmlspecialchars($post->getExcerpt(50)); ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php 
                                        $author = $post->author();
                                        echo $author ? htmlspecialchars($author->name) : 'Unknown';
                                        ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="/posts/<?php echo $post->id; ?>" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                        <a href="/posts/<?php echo $post->id; ?>/edit" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
                                        <form action="/posts/<?php echo $post->id; ?>/delete" method="POST" class="inline">
